  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="flex flex-col lg:flex-row max-w-6xl xl:max-w-7xl mx-auto gap-5 lg:gap-8">
        ...
        <aside className="w-full lg:w-[380px] lg:sticky lg:top-16 border-r border-[var(--border)] bg-[var(--card)] h-screen overflow-y-auto">
          <div className="w-[98%] mx-auto py-5 space-y-5">
            <div className="flex items-center gap-4 border border-[var(--border)] bg-[var(--card)] rounded-xl p-4">
              <img
                src="https://avatars.githubusercontent.com/u/177422234?v=4"
                alt="Brian - Full Stack Developer"
                className="w-16 h-16 rounded-full border border-[var(--border)] object-cover"
              />
            ...
            <div className="border border-[var(--border)] bg-[var(--card)] rounded-xl p-4">
              <Hero />
            </div>
          </div>
        </aside>
