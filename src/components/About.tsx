...
export default function About() {
  ...
  return (
    <section id="about" className="py-6 bg-white border-b border-[#E6E6E6]" ref={ref}>
      <div className="px-4">
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4">
            <h3 className="text-lg font-semibold text-black mb-4">What I bring to the table:</h3>
            <ul className="space-y-3 text-black/70">
              <li className="flex items-start">
                <span className="text-[#1DA1F2] mr-3">▹</span>
